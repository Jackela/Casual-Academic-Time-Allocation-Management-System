...
class TimesheetTest {
    ...
    void testGettersAndSetters() {
        ...
        timesheet.setStatus(ApprovalStatus.PENDING_LECTURER_APPROVAL);
        ...
        assertThat(timesheet.getStatus()).isEqualTo(ApprovalStatus.PENDING_LECTURER_APPROVAL);
    ...
    void testReject() {
        ...
        assertThat(approval.getPreviousStatus()).isEqualTo(ApprovalStatus.PENDING_LECTURER_APPROVAL);
    ...
    void testApprovalWorkflow() {
        ...
        // 3. Approve by tutor (goes to HR review)
        ...
        assertThat(timesheet.getApprovals()).hasSize(3);
    }
