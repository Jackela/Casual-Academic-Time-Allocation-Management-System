...
class ApprovalEntityTest {
    ...
    private static final ApprovalStatus NEW_STATUS = ApprovalStatus.PENDING_HR_REVIEW;
    ...
    class StatusTransitionTests {
        ...
        void validateBusinessRules_ShouldPassForValidTutorApprovalTransition() {
            ...
            approval.setNewStatus(ApprovalStatus.PENDING_HR_REVIEW);
            approval.setAction(ApprovalAction.APPROVE);
        ...
        void validateBusinessRules_ShouldPassForValidHRApprovalTransition() {
            approval.setPreviousStatus(ApprovalStatus.PENDING_HR_REVIEW);
            approval.setNewStatus(ApprovalStatus.APPROVED);
            approval.setAction(ApprovalAction.APPROVE);
        ...
        void validateBusinessRules_ShouldFailForInvalidTransition() {
            ...
            approval.setPreviousStatus(ApprovalStatus.APPROVED);
    ...
    class ApprovalScenariosTests {
        ...
        void tutorApproval_ShouldHaveCorrectProperties() {
            Approval tutorApproval = new Approval(
                ...
                ApprovalStatus.PENDING_TUTOR_REVIEW, ApprovalStatus.PENDING_HR_REVIEW,
                "Looks good to me"
            );
            ...
            assertThat(tutorApproval.getNewStatus()).isEqualTo(ApprovalStatus.PENDING_HR_REVIEW);
        ...
        void hrApproval_ShouldHaveCorrectProperties() {
            Approval hrApproval = new Approval(
                ...
                ApprovalStatus.PENDING_HR_REVIEW, ApprovalStatus.APPROVED,
                "Final approval granted"
            );

            assertThat(hrApproval.isApproval()).isTrue();
            assertThat(hrApproval.getPreviousStatus()).isEqualTo(ApprovalStatus.PENDING_HR_REVIEW);
            assertThat(hrApproval.getNewStatus()).isEqualTo(ApprovalStatus.APPROVED);
        ...
        void modificationRequest_ShouldHaveCorrectProperties() {
            Approval modificationRequest = new Approval(
                ...
                ApprovalStatus.PENDING_HR_REVIEW, ApprovalStatus.MODIFICATION_REQUESTED,
            ...
            assertThat(modificationRequest.getPreviousStatus()).isEqualTo(ApprovalStatus.PENDING_HR_REVIEW);
