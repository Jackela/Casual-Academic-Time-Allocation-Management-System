...
class TimesheetRepositoryTest {
    ...
    void testFindByStatus() {
        ...
        pending.setStatus(ApprovalStatus.PENDING_LECTURER_APPROVAL);
        ...
        List<Timesheet> pendingTimesheets = timesheetRepository.findByStatus(ApprovalStatus.PENDING_LECTURER_APPROVAL);
        ...
        assertThat(pendingTimesheets.get(0).getStatus()).isEqualTo(ApprovalStatus.PENDING_LECTURER_APPROVAL);
    }
    ...
    void testFindByStatusIn() {
        ...
        // When
        List<ApprovalStatus> statuses = Arrays.asList(ApprovalStatus.DRAFT, ApprovalStatus.PENDING_LECTURER_APPROVAL);
        List<Timesheet> found = timesheetRepository.findByStatusIn(statuses);

        // Then
        assertThat(found).hasSize(2);
        assertThat(found).extracting(Timesheet::getStatus)
                .containsExactlyInAnyOrder(ApprovalStatus.DRAFT, ApprovalStatus.PENDING_LECTURER_APPROVAL);
    }
    ...
    void testFindByWeekStartDateBetween() {
        ...
        // When
        List<Timesheet> found = timesheetRepository.findByWeekStartDateBetween(startDate, endDate);
    ...
    void testFindByTutorIdAndWeekStartDateBetween() {
        ...
        // When
        List<Timesheet> found = timesheetRepository.findByTutorIdAndWeekStartDateBetween(
    ...
    void testExistsByTutorIdAndCourseIdAndWeekStartDate() {
        ...
        // When & Then
        assertThat(timesheetRepository.existsByTutorIdAndCourseIdAndWeekStartDate(
    ...
    void testFindByTutorIdAndCourseIdAndWeekStartDate() {
        ...
        Optional<Timesheet> notFound = timesheetRepository.findByTutorIdAndCourseIdAndWeekStartDate(
    ...
    void testGetTotalApprovedBudgetUsedByCourse() {
        ...
        approved1.setStatus(ApprovalStatus.FINAL_APPROVED);
        ...
        approved2.setStatus(ApprovalStatus.FINAL_APPROVED);
    ...
    void testFindPendingTimesheetsForApprover() {
        ...
        pendingHR.setStatus(ApprovalStatus.PENDING_HR_REVIEW);
        ...
        assertThat(hrPending.get(0).getStatus()).isEqualTo(ApprovalStatus.PENDING_HR_REVIEW);
    ...
    void testFindPendingLecturerApprovalByCourses() {
        ...
        timesheet3.setStatus(ApprovalStatus.PENDING_LECTURER_APPROVAL);
    ...
    void testFindByStatusOrderByCreatedAtAsc() {
        ...
        older.setStatus(ApprovalStatus.PENDING_LECTURER_APPROVAL);
        
        Timesheet newer = new Timesheet(tutor.getId(), course.getId(), weekStartDate.plusWeeks(1),
                new BigDecimal("3.0"), new BigDecimal("25.00"), "Newer pending", lecturer.getId());
        newer.setStatus(ApprovalStatus.PENDING_LECTURER_APPROVAL);
        ...
        Page<Timesheet> found = timesheetRepository.findByStatusOrderByCreatedAtAsc(
                ApprovalStatus.PENDING_LECTURER_APPROVAL, PageRequest.of(0, 10));
    ...
    void testTimesheetSummarySystemWide() {
        ...
        Timesheet timesheet2 = new Timesheet(anotherTutor.getId(), course.getId(), LocalDate.of(2024, 3, 11),
                new BigDecimal("3.0"), new BigDecimal("30.00"), "Work 2", lecturer.getId());
        timesheet2.setStatus(ApprovalStatus.PENDING_HR_REVIEW);
